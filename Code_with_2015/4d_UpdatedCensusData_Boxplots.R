...
Lupine_Density_2009_2015_grouped_live2 <- as.data.frame(Lupine_Density_2009_2015_grouped_live_all)
...
lupinemedian <- ggplot_build(boxplot_2015Census_nb)$data[[1]][, c("x", "middle")]
view(lupinemedian)
...
immaturemedian <- ggplot_build(boxplot_Immature_Count)$data[[1]][, c("x", "middle")]
view(immaturemedian)
